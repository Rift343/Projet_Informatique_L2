...
def BDD():          #les questions qui ont cette étiquette
    return render_template("templates/BDD.html")
...
def creationQuestion():
    return render_template("templates/creationQuestion.html")
...
def ajoutQuestion():
    ...
    #return render_template("templates/question/"+idQuestion+".html") #On renvoie la personne sur la vue de la question créée (si elle a bien été créée)

@app.route("/question/<idQuestion>") #Page de visualisation d'une question
def creationQuestion(idQuestion):
    return render_template("templates/"+idQuestion+".html")

@app.route("/modificationQuestion/<idQuestion>") #Page de modification d'une question
def modifierQuestion(idQuestion):
    return render_template("templates/modificationQuestion/"+idQuestion+".html") #pour la modification il faut récupérer les infos existantes de la question et refaire la même chose qu'à la création
...
def modificationQuestion(idQuestion):
    ...
    #return render_template("templates/question/"+idQuestion+".html")


@app.route("/creationFeuille") #Page de création d'une feuille de questions
def creationFeuille():
    return render_template("templates/creationFeuille.html")
